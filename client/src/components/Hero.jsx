...
const Hero = () => {
  ...
  return (
    ...
    <div className='text-center mb-6'>
        <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2'>Create Outstanding Content <br />with <span className='text-primary'>WorkLr.ai</span>
</h1>
<p>
    Elevate your content strategy using Worklr.ai’s powerful AI solutions. 
    Draft blogs, design visuals, and boost productivity with ease.
</p>
    </div>
