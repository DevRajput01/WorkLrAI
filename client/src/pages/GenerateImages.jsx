import { CodeXmlIcon, Image } from 'lucide-react'
...
const imageStyle =[ 'Realistic','Ghibili style', 'Anime style', 'Cartoon Style', 'Fantasy style', 'Realistic Style', '3D style', 'Portrait Style' ]  
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      <form  onSubmit={onSubmitHandler}  className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'  >
        <div className='flex items-center gap-3' >
          <CodeXmlIcon className='w-6 text-purple-700' />
...
<p>Enter the detail and click "Generate Image" with WorkLr.ai</p>
  </div>
</div>
